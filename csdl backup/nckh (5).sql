...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 09, 2018 lúc 01:13 SA
...
(1, 'Ngô Thanh', 'Lý', 'Nam', '1996-01-06', 'Vĩnh Long', 'Vĩnh Long', '', 'Thạc sĩ', '', 'Phó giáo sư', '', 'Trưởng khoa', 'Khoa công nghệ thông tin', 'Vĩnh Long', '', '', '01212523635', '', 'lythanhngodev@gmail.com', 'Công nghệ thông tin', '1996', 'VLUTE', 'Công nghệ thông tin', '1996', 'VLUTE', '', 'Giảng viên hạng AII', 'Trung cấp', 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 'user.png', 'binhthuong', b'1', '');
...
--
ALTER TABLE `detai_nguoidung`
  MODIFY `IDDTND` bigint(20) NOT NULL AUTO_INCREMENT;
--
