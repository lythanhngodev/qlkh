...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 21, 2018 lúc 01:31 SA
...
(1, 'Bản tin số 1hh', 'images/news.png', 'Mo tảhh', '<p>đgdghh</p>\n', 'ban-tin-so-1hh', 2, NULL, b'1');
...
(1, 'NCKH.01.01', 'Đề tài số 1', 'Mục tiêu đề tài số 1', '', 'Cấp trường', '', 'không', '', '', '', '', '12000', '123000', 4, '2018-05', '2018-08', 'Sản phẩm', NULL, '2018-05-18 14:09:08', 'Đang thực hiện', 0, NULL, b'1'),
(2, 'NCKH.01.02', 'Nghiệm thu 01', '', '', 'Cấp trường', '', '', '', '', '', '', '100', '209', 1, '2018-05', '2018-06', '', '', '2018-05-18 14:21:00', 'Đã nghiệm thu', 80, '2018-05-18', b'1'),
(3, 'NCKH.1028.22', 'Đề tài nghiệm thu 2', '', '', 'Cấp trường', '', '', '', '', '', '', '4', '4', 4, '2018-05', '2018-09', '', '', '2018-05-18 18:08:07', 'Đã nghiệm thu', 22, '2018-05-25', b'1'),
(4, 'NCKH.001.2', 'de tai 3', 'đ', '', 'Cấp trường', '', 'scs', '', '', '', '', '4', '2', 4, '2018-05', '2018-08', 'san pham', NULL, '2018-05-18 19:06:39', 'Đang thực hiện', 0, NULL, b'1'),
(5, 'NCKH.01.03', 'Nssv', 'dbsd', '', 'Cấp trường trọng điểm', '', '', '', '', '', '', '0', '0', 4, '2018-05', '2018-09', '', NULL, '2018-05-19 00:36:05', 'Đang xét duyệt', 0, NULL, b'1'),
(6, NULL, 'Ví dụ 1', '', '', 'Cấp trường', '', '', '', '', '', '', '12', '13', 2, '2018-05', '2018-07', '', NULL, '2018-05-21 07:58:07', 'Đang xét duyệt', 0, NULL, b'1');
...
(1, 1, '2018-05-18 14:09:18'),
(2, 2, '2018-05-18 14:21:00'),
(3, 3, '2018-05-18 18:08:07'),
(4, 4, '2018-05-18 19:06:49'),
(5, 5, '2018-05-19 00:36:15'),
(6, 6, '2018-05-21 08:03:51');
...
--
-- Cấu trúc bảng cho bảng `hoidongxetchon`
--

CREATE TABLE `hoidongxetchon` (
  `IDHD` bigint(20) NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `hoidongxetchon`
--

INSERT INTO `hoidongxetchon` (`IDHD`, `IDND`, `NHIEMVU`, `GHICHU`) VALUES
(9, 2, 'Chủ tịch', 'Thành viên cố định'),
(10, 5, 'Uỷ viên', '-nt-'),
(11, 3, 'Thư ký', '-nt-');
...
(1, 'Khoa Công nghệ thông tin', 'Khoa CN TT'),
...
(4, 1, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(5, 1, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(6, 1, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(7, 1, 'Phtas sinh', '3', '4', '5'),
(8, 2, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(9, 2, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(10, 2, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(11, 3, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(12, 3, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(13, 3, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(23, 5, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(24, 5, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(25, 5, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(26, 4, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(27, 4, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(28, 4, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(29, 6, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(30, 6, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(31, 6, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0');
...
(2, 1, 'Khoa học giáo dục'),
(3, 2, 'Khoa học tự nhiên'),
(4, 3, 'Khoa học tự nhiên'),
(8, 5, 'Khoa học Y - Dược'),
(9, 4, 'Xã hội nhân văn'),
(10, 6, 'Khoa học giáo dục');
...
(4, 3, 'Nghiên cứu ứng dụng'),
(8, 5, 'Nghiên cứu ứng dụng'),
(9, 4, 'Nghiên cứu ứng dụng'),
(10, 6, 'Nghiên cứu cơ bản');
...
(2, 'Lê Hồng', 'Kỳ', 'Nam', NULL, '', '', '', '', '', '', '', '', '', '', 'kylh@vlute.edu.vn', '', '', '', '', '', '', '', 'kylh@vlute.edu.vn', '727686db9184c20da110ad841418e602', 'user.png', 'binhthuong', b'1', NULL),
(3, 'Đoàn Ngọc', 'Tố', 'Nam', NULL, '', '', '', '', '', '', '', '', '', '', 'todn@vlute.edu.vn', '', '', '', '', '', '', '', 'todn@vlute.edu.vn', 'ff61067db5ad009ceb4b46fb9b3e4e67', 'user.png', 'binhthuong', b'1', NULL),
...
(5, 'Nguyễn Văn', 'Tâm', 'Nam', NULL, '', '', '', '', '', '', '', '', '', '', 'tamnv63@vlute.edu.vn', '', '', '', '', '', '', '', 'tamnv63@vlute.edu.vn', 'e5110d330a01c56baa957b84da6165ad', 'user.png', 'binhthuong', b'1', NULL),
...
(9, 'Vũ Trung', 'Kiên', 'Nam', NULL, '', '', '', '', '', '', '', '', '', '', 'lythanhdev@vlute.edu.vn', '', '', '', '', '', '', '', 'kienvt@vlute.edu.vn', '08773f9cd36c7e84c14b8b798a093d65', 'user.png', 'binhthuong', b'1', NULL),
...
(1, 2, 1, '', 1, '2018-05-18 14:21:00', NULL),
(2, 2, 1, '', 0, '2018-05-18 14:21:00', NULL),
(11, 3, 2, 'a', 1, '2018-05-18 18:08:07', 'b'),
(12, 3, 8, 'c', 0, '2018-05-18 18:08:07', 'd'),
(13, 1, 2, 'Uỷ viên', 1, '2018-05-18 18:54:13', '-nt-'),
(14, 1, 3, 'Thư ký', 1, '2018-05-18 18:54:13', '-nt-'),
(15, 1, 10, 'Uỷ viên', 0, '2018-05-18 18:54:13', 'Theo đề tài'),
(37, 5, 2, 'Chủ tịch', 1, '2018-05-19 09:59:01', 'Thành viên cố định'),
(38, 5, 5, 'Uỷ viên', 1, '2018-05-19 09:59:01', '-nt-'),
(39, 5, 3, 'Thư ký', 1, '2018-05-19 09:59:01', '-nt-'),
(40, 5, 9, 'g', 0, '2018-05-19 09:59:01', 'h'),
(41, 5, 8, 'f', 0, '2018-05-19 09:59:01', 'f'),
(42, 5, 7, 'f', 0, '2018-05-19 09:59:01', 'f'),
(43, 4, 2, 'Chủ tịch', 1, '2018-05-19 11:21:20', 'Thành viên cố định'),
(44, 4, 5, 'Uỷ viên', 1, '2018-05-19 11:21:20', '-nt-'),
(45, 4, 3, 'Thư ký', 1, '2018-05-19 11:21:20', '-nt-'),
(46, 4, 7, 'Uỷ viên', 0, '2018-05-19 11:21:20', 'Phản biện 1'),
(47, 4, 8, 'Uỷ viên', 0, '2018-05-19 11:21:20', 'Phản biện 2'),
(48, 4, 11, 'Uỷ viên', 0, '2018-05-19 11:21:20', '');
...
(1, 2, 1, '', '2018-05-18 14:21:00', NULL),
(3, 1, 9, 'Ủy viên', '2018-05-18 17:50:31', 'Phản biện 2'),
(5, 3, 4, 'e', '2018-05-18 20:53:12', 'f'),
(6, 5, 11, 'a', '2018-05-19 01:24:50', 'b'),
(7, 5, 9, 'c', '2018-05-19 01:24:50', 'd'),
(8, 5, 6, 'e', '2018-05-19 01:24:50', 'f');
...
--
-- Chỉ mục cho bảng `hoidongxetchon`
--
ALTER TABLE `hoidongxetchon`
  ADD PRIMARY KEY (`IDHD`),
  ADD UNIQUE KEY `hoidongxetchon_IDND_uindex` (`IDND`);
...
--
ALTER TABLE `baiviet`
  MODIFY `IDBV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT cho bảng `baiviet_chuyenmuc`
--
ALTER TABLE `baiviet_chuyenmuc`
  MODIFY `IDBVCM` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `detai`
  MODIFY `IDDT` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT cho bảng `dexuatdetai`
--
ALTER TABLE `dexuatdetai`
  MODIFY `IDDX` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
-- AUTO_INCREMENT cho bảng `hoidongxetchon`
--
ALTER TABLE `hoidongxetchon`
  MODIFY `IDHD` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `kinhphi`
  MODIFY `IDKP` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
...
--
ALTER TABLE `linhvuckhoahoc`
  MODIFY `IDLV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `loaihinhnghiencuu`
  MODIFY `IDLH` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `loaitaikhoan_nguoidung`
  MODIFY `IDLTKND` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `nguoidung`
  MODIFY `IDND` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `nguoidung_chucdanhgiangvien`
  MODIFY `IDNDCDGV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT cho bảng `nguoidung_chucdanhkhoahoc`
--
ALTER TABLE `nguoidung_chucdanhkhoahoc`
  MODIFY `IDNDCD` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT cho bảng `nguoidung_chucvu`
--
ALTER TABLE `nguoidung_chucvu`
  MODIFY `IDNDCV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT cho bảng `nguoidung_hocvi`
--
ALTER TABLE `nguoidung_hocvi`
  MODIFY `IDNDHV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT cho bảng `nguoidung_khoabomon`
--
ALTER TABLE `nguoidung_khoabomon`
  MODIFY `IDNDKBM` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT cho bảng `nguoidung_trinhdochuyenmon`
--
ALTER TABLE `nguoidung_trinhdochuyenmon`
  MODIFY `IDNDTDCM` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `thanhviendetai`
  MODIFY `IDTV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `xetduyetdetai`
  MODIFY `IDXD` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT cho bảng `xetduyetnghiemthu`
--
ALTER TABLE `xetduyetnghiemthu`
  MODIFY `IDNT` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
