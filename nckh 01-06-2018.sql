...
(10, 2, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(11, 2, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(12, 2, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(13, 3, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(14, 3, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(15, 3, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(16, 4, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(17, 4, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(18, 4, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(19, 5, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(20, 5, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(21, 5, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(25, 6, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(26, 6, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(27, 6, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0'),
(28, 7, 'Chi thuê khoán chuyên môn', '0', '0', '0'),
(29, 7, 'Chi mua nguyên vật liệu', '0', '0', '0'),
(30, 7, 'Chi sửa chữa, mua sắm TSCĐ', '0', '0', '0');
...
--
ALTER TABLE `baiviet`
  MODIFY `IDBV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `baiviet_chuyenmuc`
--
ALTER TABLE `baiviet_chuyenmuc`
  MODIFY `IDBVCM` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `baiviet_tukhoa`
  MODIFY `IDTKBV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `detai`
  MODIFY `IDDT` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `kinhphi`
  MODIFY `IDKP` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `loaitaikhoan_nguoidung`
  MODIFY `IDLTKND` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=215;
...
--
ALTER TABLE `nguoidung`
  MODIFY `IDND` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=215;
...
--
ALTER TABLE `thanhviendetai`
  MODIFY `IDTV` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tukhoa`
  MODIFY `IDKHOA` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `xetduyetdetai`
--
ALTER TABLE `xetduyetdetai`
  MODIFY `IDXD` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `xetduyetnghiemthu`
--
ALTER TABLE `xetduyetnghiemthu`
  MODIFY `IDNT` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
