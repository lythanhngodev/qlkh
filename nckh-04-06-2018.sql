...
-- Dumping data for table nckh.baibao_tukhoa: ~17 rows (approximately)
...
-- Dumping data for table nckh.baokhoahoc: ~22 rows (approximately)
...
INSERT INTO `baokhoahoc` (`IDBAO`, `TENBAO`, `CAPBAIBAO`, `TENQG`, `TAPCHI`, `NAMXUATBAN`, `NOIDUNG`, `BIB`, `NGAYDANGBAI`, `FILE`, `DIEM`, `SOTIET`, `ANHIEN`) VALUES
	(1, 'Công tác đào tạo bồi dưỡng  giáo viên dạy nghề tại trường Đh SPKT Vĩnh Long thực trạng và giải pháp', 'Cấp trường', 'Vietnam', 'Bài bái cấp trường', '2014-05', '', '', '2018-05-26', '', 78, 10, b'1'),
	(2, 'Ứng dụng Kit Arduion Uno vào hệ thống điều khiển tự động Application Kit Rduino Uno In Automatic Control Systems', 'Cấp trường', 'Vietnam', '', '2014-04', '', '', '2018-05-26', '', 66, 20, b'1'),
	(3, 'Phân tích lịch trình  giảng dạy sử dụng trong đào tạo theo học chế tín chỉ', 'Cấp trường', 'Vietnam', '', '2016-04', '<p>Ph&acirc;n t&iacute;ch lịch tr&igrave;nh&nbsp; giảng dạy sử dụng trong đ&agrave;o tạo theo học chế t&iacute;n chỉ</p>\n', '', '2018-06-04', '', 50, 10, b'1'),
...
-- Dumping data for table nckh.capbaibao: 1 rows
...
-- Dumping data for table nckh.congtacchuyenmon: ~1 rows (approximately)
...
INSERT INTO `congtacchuyenmon` (`IDCT`, `IDND`, `THOIGIAN`, `NOICONGTAC`, `CONGVIEC`) VALUES
	(2, 1, '2018-04-20', 'VLUTE', 'Sinh viên');
...
-- Dumping data for table nckh.daihoc: ~1 rows (approximately)
...
INSERT INTO `daihoc` (`IDDH`, `IDND`, `HEDAOTAO`, `NOIDAOTAO`, `NGANHHOC`, `NUOCDAOTAO`, `NAMTOTNGHIEP`) VALUES
	(4, 1, 'Đại học', 'Vĩnh Long', 'CNTT', 'Việt Nam', 2018);
...
-- Dumping data for table nckh.loaitaikhoan_nguoidung: ~209 rows (approximately)
...
-- Dumping data for table nckh.nguoidung: ~209 rows (approximately)
...
INSERT INTO `nguoidung` (`IDND`, `HO`, `TEN`, `GIOITINH`, `NGAYSINH`, `NOISINH`, `QUEQUAN`, `DANTOC`, `NAMNUOCHOCVI`, `NAMBONHIEM`, `CHOORIENG`, `DIENTHOAICQ`, `DIENTHOAINR`, `DIENTHOAIDD`, `FAX`, `MAIL`, `THACSICHUYENNGANH`, `NAMCAPBANGTSCN`, `NOIDAOTAOTSCN`, `TIENSICHUYENNGANH`, `NAMCAPBANGTSCN2`, `NOIDAOTAOTSCN2`, `TENLUANAN`, `TENDANGNHAP`, `MATKHAU`, `HINH`, `TRANGTHAI`, `XACNHAN`, `TOKEN`) VALUES
	(1, 'Ngô Thanh', 'Lý', 'Nam', '1996-01-06', 'Vĩnh Long', 'Vĩnh Long', '', '', '', 'Vĩnh Long', '', '', '01214967197', '', 'lythanhngodev@gmail.com', 'Công nghệ thông tin', '1996', 'VLUTE', 'Công nghệ thông tin', '1996', 'VLUTE', 'Phần mềm quản lý các nghiên cứu khoa học', 'admin', '2ce502b9ce9efd95d660a835fb67d1ec', 'user.png', 'binhthuong', b'1', ''),
	...
	(427, 'Phùng Văn', 'Thiện', 'Nam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'thienpv@vlute.edu.vn', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'thienpv@vlute.edu.vn', 'cd15ba812a1733a9310c7c9dfd8a8ac9', 'user.png', 'binhthuong', b'1', NULL),
	(428, 'Lưu Duy', 'Chân', 'Nam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'chanld@vlute.edu.vn', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'chanld@vlute.edu.vn', '4a7d597ac4326f6275fcf00533196d70', 'user.png', 'binhthuong', b'1', NULL),
	(429, 'Nguyễn Thị Hồng', 'Trang', 'Nam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'trangnth@vlute.edu.vn', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'trangnth@vlute.edu.vn', '09fc9d715576b282d3bacdd1ed0843c9', 'user.png', 'binhthuong', b'1', NULL),
	(430, 'Diệp Xuân', 'Tài', 'Nam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'taidx@vlute.edu.vn', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'taidx@vlute.edu.vn', '6ec2e5939d095629539c94f3003a2e7b', 'user.png', 'binhthuong', b'1', NULL),
	(431, 'Huỳnh Hoàng', 'Bửu', 'Nam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'buuhh@vlute.edu.vn', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'buuhh@vlute.edu.vn', '5562ec0eac0c5f0396a6d00812bf6f56', 'user.png', 'binhthuong', b'1', NULL);
...
-- Dumping data for table nckh.nguoidung_baibao: ~33 rows (approximately)
...
-- Dumping data for table nckh.nguoidung_chucdanhgiangvien: ~20 rows (approximately)
...
-- Dumping data for table nckh.nguoidung_chucdanhkhoahoc: ~20 rows (approximately)
...
-- Dumping data for table nckh.nguoidung_chucvu: ~20 rows (approximately)
...
-- Dumping data for table nckh.nguoidung_hocvi: ~20 rows (approximately)
...
-- Dumping data for table nckh.nguoidung_khoabomon: ~20 rows (approximately)
...
-- Dumping data for table nckh.nguoidung_trinhdochuyenmon: ~20 rows (approximately)
...
-- Dumping data for table nckh.tukhoa: ~22 rows (approximately)
