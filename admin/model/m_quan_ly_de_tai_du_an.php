<?php 
	...
	function lay_de_xuat_du_an(){
		...
		$conn = $ketnoi->ketnoi();
		$query = "SELECT dx.IDDT, dx.NGAYDEXUAT, `TENDETAI`, `MUCTIEU`, `NOIDUNG`, `CAPDETAI`, `NGAYTHEM`, `TRANGTHAI` FROM dexuatdetai dx, detai dt WHERE dx.IDDT = dt.IDDT ORDER BY dx.IDDX DESC";
