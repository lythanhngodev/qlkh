...
<?php 
 ...
 <div class="card">
 	<div class="card-header">
 		<h4>Phiếu giao nhận sản phẩm (Thiết bị)</h4>
		    ...
		    $detai = lay_de_xuat_du_an();
		     while ($row = mysqli_fetch_assoc($detai)){ ?>
		        <tr>
		            ...
		            <td class="giua">
		                <a href="word/phieu_giao_nhan_san_pham_thiet_bi.php?id=<?php echo $row['IDDT']; ?>" target="_blank" class="btn btn-warning btn-sm"><i class="far fa-file-word"></i> Xuất file</a>
		            </td>
		        </tr>
		    <?php $stt++; } ?>
		    </tbody>
