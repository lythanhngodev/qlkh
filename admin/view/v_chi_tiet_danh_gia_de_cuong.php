                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" data-toggle="tab" href="#nav-tai-lieu-xet-duyet" aria-selected="false">Tải lên TL xét duyệt</a>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane" id="nav-tai-lieu-xet-duyet" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <br>
                                <div id="quanlyupfile" class="col-md-12 giua">
                                    <?php if($detai['XDFILE']!=''){
                                        ...
                                        echo "<a id='taifile' class='btn btn-success btn-lg' style='display: none;'><i class='fas fa-upload faa-float animated' ></i>&ensp;Tải lên tài liệu xét duyệt</a>";
                                        echo "<input type='text' hidden='hidden' value='".$detai['XDFILE']."' id='tenfiledaup'>";
                                    }else{
                                        echo "<a id='taifile' class='btn btn-success btn-lg'><i class='fas fa-upload faa-float animated' ></i>&ensp;Tải lên tài liệu xét duyệt</a>";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#danhgiadecuong').addClass('active');
        $(function () {
        ...
        $('#filetailen').on('change',function () {
            ...
            if(type == match[0] || type == match[1] || type == match[2] || type == match[3] || type == match[4] || type == match[5]){
                ...
                form_data.append('dt',<?php echo trim($detai['IDXD']," ")?>);
                //sử dụng ajax post
                if (kiemtraketnoi()){
                    $.ajax({
