                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-5">
                                        <div id="f-tukhoa" class="form-group">
                                          ...
                                          <input name="tags" id="tukhoa" value="<?php echo lay_tu_khoa($baiviet['IDBV']); ?>" />
                                        ...
                                        <div id="f-tukhoa" class="form-group">
                                          ...
                                          <select class="form-control" id="loaitin">
                                            <?php while ($row = mysqli_fetch_assoc($cm)) { ?>
                                              <option value="<?php echo $row['IDCM'] ?>" <?php if(lay_bai_viet_chuyen_muc($baiviet['IDBV']) == $row['IDCM']) echo "selected" ?>><?php echo $row['TENCM'] ?></option>
                                            <?php } ?>
                                          </select>
                                        </div>
                                      </div>
                                      <div class="col-md-12">
                                        <div class="col-md-7" style="padding: 0;">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" id="noidungbaibao"><?php echo $baiviet['NOIDUNG'] ?></textarea>
                                            </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          <label for="tags" class="font-weight-bold" >Ngày đăng bài</label>
                                            <input type="date" class="form-control" id="ngaydang" value="<?php echo $baiviet['NGAYDANG'] ?>">
                                        </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                      ...
                                      <div class="col-md-4">
                                        <img src="<?php echo $qlkh['HOSTGOC'].$baiviet['HINHANH'] ?>" id="hinh-anh-ht" style="width: 100%;">
                                      </div>
                                  </div>
                              </div>
                        </div>
