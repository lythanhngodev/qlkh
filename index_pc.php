		...
		<div class="menu">
			<div id="nav">
        		<ul class="sf-menu">
					...
					<li id="timkiemggg"><a href="timkiemgg">Tìm kiếm</a></li>
				</ul>
			</div>
		</div>
		<div id="sr_bg">		
